...
net.Receive("mu_adminpanel_details",function(bytes)
	local json = util.JSONToTable(util.Decompress(net.ReadData(bytes)))
	playerData = json["playerData"]
	lootData = json["lootData"]
end)
