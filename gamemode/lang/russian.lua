...
pt.startHelpBystander = {"Убийца на свободе","Не умрите"}

pt.startHelpGunTitle = "Вы свидетель"
pt.startHelpGunSubtitle = "с секретным оружием"

pt.startHelpGun = {"Убийца на свободе","Найдите и убейте его"}

pt.startHelpMurdererTitle = "Вы убийца"

pt.startHelpMurderer = {"Убейте всех","Но не попадитесь!"}
