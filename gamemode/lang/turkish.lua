...
pt.startHelpBystander = {"Etrafta bir katil dolanmakta","hayatta kalmaya çalış!"}

pt.startHelpGunTitle = "Sen elinde gizli bir silahı"
pt.startHelpGunSubtitle = "olan özel birisin."

pt.startHelpGun = {"Etrafta bir katil dolanmakta","onu bul ve öldür!"}

pt.startHelpMurdererTitle = "Sen katilsin."

pt.startHelpMurderer = {"Herkesi öldür","ve yakalanma!"}
