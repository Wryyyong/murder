...
pt.startHelpBystander = {"Morderca jest na wolnoÅ›ci","Nie daj siÄ™ zabiÄ‡"}

pt.startHelpGunTitle = "JesteÅ› Å›wiadkiem"
pt.startHelpGunSubtitle = "z sekretnÄ… broniÄ…"

pt.startHelpGun = {"Morderca jest na wolnoÅ›ci","ZnajdÅº go i zabij"}

pt.startHelpMurdererTitle = "JesteÅ› mordercÄ…"

pt.startHelpMurderer = {"Zabij wszystkich","Nie daj siÄ™ zÅ‚apaÄ‡"}
