...
function GM:LoadSpawns()
	for listName in pairs(TeamSpawns) do
...
concommand.Add("mu_spawn_counts",function(ply)
...
concommand.Add("mu_spawn_add",function(ply,_,args)
	if not ply:IsAdmin() then return end
...
concommand.Add("mu_spawn_list",function(ply,_,args)
	if not ply:IsAdmin() then return end
...
concommand.Add("mu_spawn_closest",function(ply,_,args)
	if not ply:IsAdmin() then return end
...
concommand.Add("mu_spawn_remove",function(ply,_,args)
	if not ply:IsAdmin() then return end
...
concommand.Add("mu_spawn_visualise",function(ply,_,args)
	if not ply:IsAdmin() then return end
